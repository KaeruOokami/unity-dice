...
{
    public static class MatchSetupCodec
    {
        public static MatchSetupPayload ToPayload(
        ...
        public static bool TryFromPayload(
            ...
            snapshot = null;
            if (registry == null) {
                errorMessage = "MatchSetupCodec: Preset registry is not assigned.";
                return false;
            }

            if (!System.Enum.IsDefined(typeof(GameMode), (int)payload.GameMode)) {
                errorMessage = "MatchSetupCodec: Unknown game mode.";
                return false;
            }
        ...
        static PlayerSlotSetup BuildPlayerSetup(
            ...
            byte deviceKind,
            byte gamepadIndex,
            DiceSpawnSettingsPayload spawnPayload,
            DiceCatalogPayload catalogPayload,
            PlayerAttackSettingsPayload attackPayload,
            PlayerNaturalSendSettingsPayload naturalSendPayload,
        ...
        static DiceSpawnSettingsPayload ToSpawnPayload(DiceSpawnSettingsData data) {
        ...
        static DiceSpawnSettingsData FromSpawnPayload(DiceSpawnSettingsPayload payload) {
        ...
        static DiceCatalogPayload ToCatalogPayload(DiceCatalogData data) {
        ...
        static DiceCatalogData FromCatalogPayload(DiceCatalogPayload payload, DiceCatalogData meshSource) {
            var source = payload.Entries ?? System.Array.Empty<DiceCatalogEntryPayload>();
        ...
        static PlayerAttackSettingsPayload ToAttackPayload(PlayerAttackSettingsData data) {
        ...
        static PlayerAttackSettingsData FromAttackPayload(PlayerAttackSettingsPayload payload) {
            var source = payload.FaceSendProfiles ?? System.Array.Empty<FaceAttackSendProfilePayload>();
            var profiles = new FaceAttackSendProfileData[source.Length];
            for (var i = 0; i < source.Length; i++) {
                var kindsSource = source[i].SendableKinds ?? System.Array.Empty<SendableKindLimitPayload>();
        ...
        static PlayerNaturalSendSettingsPayload ToNaturalSendPayload(PlayerNaturalSendSettingsData data) {
        ...
        static PlayerNaturalSendSettingsData FromNaturalSendPayload(PlayerNaturalSendSettingsPayload payload) {
            var source = payload.SendableKinds ?? System.Array.Empty<NaturalSendKindLimitPayload>();
        ...
        static JumboDiceSettingsPayload ToJumboPayload(JumboDiceSettingsData data) {
        ...
        static JumboDiceSettingsData FromJumboPayload(JumboDiceSettingsPayload payload) {
        ...
        static JumboDiceSettingsData ResolveJumbo(
            JumboDiceSettingsPayload payload,
