namespace DiceGame.Core
{
    public static class DiceBehaviorConstants
    {
        ...
        public const float JumboSinkDurationMultiplier = 2f;
        /// <summary>Same as <c>JumboFootprint.MatchWeightPerTierWhileErasing</c> (noEngine-safe).</summary>
        public const int JumboSinkingMatchWeightPerTier = 4;
    }
}
