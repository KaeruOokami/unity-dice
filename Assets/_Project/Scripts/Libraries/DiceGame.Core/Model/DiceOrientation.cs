...
namespace DiceGame.Core
{
    ...
    public struct DiceOrientation : IEquatable<DiceOrientation>
    {
        ...
        /// <summary>Pure face triad roll (no Unity Quaternion). Matches production / SimShared face rules.</summary>
        public DiceOrientation Roll(Direction direction) {
            return direction switch {
                Direction.North => new DiceOrientation(South, Top, East),
                Direction.South => new DiceOrientation(North, OppositeFace(Top), East),
                Direction.East => new DiceOrientation(West, North, Top),
                Direction.West => new DiceOrientation(East, North, OppositeFace(Top)),
                _ => this
            };
        }
