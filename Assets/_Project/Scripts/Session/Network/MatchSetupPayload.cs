...
{
    public struct DiceSpawnSettingsPayload : INetworkSerializable
    {
    ...
    public struct DiceCatalogEntryPayload : INetworkSerializable
    {
        public byte Kind;
    ...
    public struct DiceCatalogPayload : INetworkSerializable
    {
        public DiceCatalogEntryPayload[] Entries;
        ...
        public void NetworkSerialize<T>(BufferSerializer<T> serializer) where T : IReaderWriter {
            ...
            if (serializer.IsReader) {
                Entries = count > 0
                    ? new DiceCatalogEntryPayload[count]
                    : System.Array.Empty<DiceCatalogEntryPayload>();
            }
    ...
    public struct SendableKindLimitPayload : INetworkSerializable
    {
        public byte Kind;
    ...
    public struct FaceAttackSendProfilePayload : INetworkSerializable
    {
        public int[] TriggerFaces;
        public SendableKindLimitPayload[] SendableKinds;
        ...
        public void NetworkSerialize<T>(BufferSerializer<T> serializer) where T : IReaderWriter {
            ...
            if (serializer.IsReader) {
                SendableKinds = kindCount > 0
                    ? new SendableKindLimitPayload[kindCount]
                    : System.Array.Empty<SendableKindLimitPayload>();
            }
    ...
    public struct PlayerAttackSettingsPayload : INetworkSerializable
    {
        public FaceAttackSendProfilePayload[] FaceSendProfiles;
        ...
        public void NetworkSerialize<T>(BufferSerializer<T> serializer) where T : IReaderWriter {
            ...
            if (serializer.IsReader) {
                FaceSendProfiles = count > 0
                    ? new FaceAttackSendProfilePayload[count]
                    : System.Array.Empty<FaceAttackSendProfilePayload>();
            }
    ...
    public struct NaturalSendKindLimitPayload : INetworkSerializable
    {
        public byte Kind;
        public int MaxCountPerVolley;
        public float SelectionWeight;
    ...
    public struct PlayerNaturalSendSettingsPayload : INetworkSerializable
    {
        public bool Enabled;
        public int DiceCountPerVolley;
        public NaturalSendKindLimitPayload[] SendableKinds;
        ...
        public void NetworkSerialize<T>(BufferSerializer<T> serializer) where T : IReaderWriter {
            ...
            if (serializer.IsReader) {
                SendableKinds = count > 0
                    ? new NaturalSendKindLimitPayload[count]
                    : System.Array.Empty<NaturalSendKindLimitPayload>();
            }
    ...
    public struct JumboDiceSettingsPayload : INetworkSerializable
    {
        public bool Enabled;
    ...
    public struct MatchSetupPayload : INetworkSerializable
    {
        public const byte InvalidPresetIndex = byte.MaxValue;

        public byte GameMode;
        public DiceSpawnSettingsPayload SharedSpawn;
        public DiceCatalogPayload SharedCatalog;
        public JumboDiceSettingsPayload Jumbo;
        public byte Player1IsAi;
        public byte Player1DeviceKind;
        public byte Player1GamepadIndex;
        public DiceSpawnSettingsPayload Player1Spawn;
        public DiceCatalogPayload Player1Catalog;
        public PlayerAttackSettingsPayload Player1Attack;
        public PlayerNaturalSendSettingsPayload Player1NaturalSend;
        public byte Player2IsAi;
        public byte Player2DeviceKind;
        public byte Player2GamepadIndex;
        public DiceSpawnSettingsPayload Player2Spawn;
        public DiceCatalogPayload Player2Catalog;
        public PlayerAttackSettingsPayload Player2Attack;
        public PlayerNaturalSendSettingsPayload Player2NaturalSend;
        /// <summary>
